          ...
          {edit ? (
            <>
              <button
                ...
                disabled={saving}
                className="px-4 py-2 border rounded-xl text-red-600 border-red-600 hover:bg-red-50 transition"
              >
                Cancel
              </button>
              <button
            ...
            <button
              ...
              className="px-4 py-2 border rounded-xl text-blue-600 border-blue-600 hover:bg-blue-50 transition"
            >
              Edit Profile
            </button>
          )}
